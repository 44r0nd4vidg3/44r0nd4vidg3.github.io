# aarondavidge.com — Roadmap

Imported from Google Tasks, 2026-07-16.

## Bugs / Fixes

- [ ] Fix contact form submission
- [x] Fix meta tags
- [ ] Download CV button not present on each hamburger menu
...
- [x] Personal responsible disclosure policy
- [x] RFC 9116 `security.txt` policy
- [ ] DMARC policy for Google Workspace

## Infrastructure

- [ ] Setup emails: aaron@aarondavidge.com & bugs@aarondavidge.com
- [ ] Implement sign-in — https://aarondavidge.com/signin.html
